...
Project done during **Full Stack Software Engineering** at **ALX** to practising using PID, processes and commands that handle them (`ps`, `pgrep`, `pkill`, `kill`, etc) in **Bash**.
